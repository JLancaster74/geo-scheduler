...
async function sendEmail(to, subject, html) {
  ...
  try {
    await axios.post("https://api.sendgrid.com/v3/mail/send", {
      ...
      from: { email: process.env.FROM_EMAIL || "jonathan@jonathanlancasterremodeling.com", name: "Tom Grossman Renovations" },
...
async function notifyJonathan(subject, message) {
  ...
  // Email alert
  await sendEmail(
    process.env.YOUR_EMAIL || "tom.grossman@icloud.com",
    `🔔 ${subject}`,
  ...
  switch (type) {
    ...
    case "followup_day1":
      await sendSMS(lead.phone,
        `Hi ${firstName}! This is Tom Grossman. I truly enjoyed meeting with you today about your bath renovation. I wanted to check in — do you have any questions I can answer? Reply anytime or call me at ${process.env.YOUR_PHONE_NUMBER}.`
      );
    ...
    case "followup_day3":
      await sendSMS(lead.phone,
        `Hi ${firstName}, Tom Grossman here again! I wanted to share that we have a special financing option available this month that could make your bathroom renovation very affordable. Would you like to hear more? Reply YES or call ${process.env.YOUR_PHONE_NUMBER}.`
      );
      await notifyJonathan(
    ...
    case "followup_day7":
      await sendSMS(lead.phone,
        `Hi ${firstName}! Tom Grossman here. I know renovations are a big decision and I want to make sure you have everything you need to feel confident. I'd love to answer any questions — no pressure at all. Call me at ${process.env.YOUR_PHONE_NUMBER} or reply here anytime.`
      );
      await notifyJonathan(
    ...
    case "noshow_recovery":
      await sendSMS(lead.phone,
        `Hi ${firstName}, this is Tom Grossman. I stopped by today for our free consultation but may have missed you! I'd love to reschedule at your convenience — it only takes 60-90 minutes and is completely free. Call me at ${process.env.YOUR_PHONE_NUMBER} or reply to this text.`
      );
      await notifyJonathan(
    ...
    case "referral_request":
      await sendSMS(lead.phone,
        `Hi ${firstName}! Tom Grossman here. It was such a pleasure working with you on your bathroom renovation! If you love the results, I would be so grateful if you could share my name with friends or neighbors who might benefit. You can also leave us a Google review here: https://g.page/r/YOUR_GOOGLE_REVIEW_LINK\n\nThank you so much! — Tom`
      );
      await notifyJonathan(
    ...
    case "reengage_30":
      await sendSMS(lead.phone,
        `Hi ${firstName}, Tom Grossman here. I was thinking about our conversation and wanted to check in. Are you still considering updating your bathroom? We have some beautiful new options I think you'd love — and financing is still available. No pressure at all! Call ${process.env.YOUR_PHONE_NUMBER} anytime.`
      );
      await notifyJonathan(
    ...
    await sendEmail(email, `Your Free Report: 10 Hidden Dangers in Bathroom Renovations`,
      `<div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;color:#333">
        <div style="background:#1a1a2e;padding:30px;text-align:center">
          <h1 style="color:#C9A96E;margin:0;font-size:24px">Tom Grossman Renovations</h1>
        ...
        <div style="padding:32px 24px">
          ...
          <div style="background:#f9f5ef;border-left:4px solid #C9A96E;padding:20px;margin:24px 0;border-radius:4px">
            <p style="margin:0;font-size:15px"><strong>The best way to avoid all 10?</strong> Schedule a free in-home consultation with Tom — no pressure, no obligation.</p>
          </div>
          ...
          <p style="font-size:14px;color:#666">Questions? Call Tom directly at <strong>972-352-7632</strong></p>
        </div>
        <div style="background:#f5f5f5;padding:16px;text-align:center;font-size:12px;color:#999">
          Tom Grossman Renovations · Mountain Home &amp; Jonesboro, AR · 972-352-7632
        </div>
      </div>`
    );
  }
